...
from core.forms import (AddressForm, AddToWishlistForm, AddToWishlistFormSet,
                        BillingAddressForm, CartItemFormSet, CurrencyForm,
                        CustomUserCreationForm, FeedbackForm,
                        ProductReviewForm, ProfileForm, ShippingAddressForm,
                        WishlistForm)
from core.models import (Address, Cart, CartItem, CategoryModel, Feedback,
                         Order, Payment, ProductModel, Profile, WishlistModel)
