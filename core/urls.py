...
urlpatterns = [
    ...
    path("user/signup/", views.SignupView.as_view(), name="user_registration"),
    ...
    path("product/category/<str:category>/product/", views.ProductListByCategory.as_view(), name="product_by_category"),
